...
public class JoinTests {
    ...
    /**
     * 조인의 종류
     * 1. 일반 조인 : 일반적인 sql 조인을 의미(내부 조인, 외부조인, 컬렉션조인, 세터조인)
     * 2. 페치 조인 : Jpql에서 성능 최젃화를 위해 제공하는 기능으로 연관된 엔티티나 컬렉션을 한 번에 조회할 수 있따.
    ...
    public void 외부조인을_이용한_조회_테스트(){
        // 연관관계가 맺어진 엔티티들의 대한 Left or right Outer 조인을 말한다.
    ...
    @Test
    public void 폐치조인을_이용한_조회_테스트(){
        // 폐치 조인을 하면 처음 sql 실행 후 로딩할 때 조인 결과를 다 조회한 뒤에 사용하는 방식이기 떄문에 쿼리 실행 횟수가 줄어들게된다.
        // 대부분의 경우 성능이 향상된다.
